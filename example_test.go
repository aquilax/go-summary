...
func Example() {
	text := `Действието започва една вечер в двора на чорбаджи Марко, който вечеря с многолюдното си семейство. След вечерята той изпраща жена си при болния си син Асен, който е трескав, защото видял трупа на едно обезглавено от страшния бандит Емексиз Пехливан дете. В този момент се чува тропот при дувара, а слугинята се разкрещява. Марко отива да види какво е станало и там се натъква на Иван Краличът, който му се представя. Като най-близък приятел на баща му той решава да го скрие у дома си, но виковете на слугинята вече са предизвикали хората да повикат онбашия и турците вече тропат на вратата. В това време беглецът прескача зида и се измъква от заптиетата, но при сборичкването си с един от тях връхната му дреха остава в ръцете му.
...
В манастира беглецът е добре приет от дякон Викентий, който се отнася гостоприемно с бунтовниците. На другия ден се връща и игуменът Натанаил, който носи лоши новини от града. Доктор Соколов през нощта е бил арестуван и откаран. Когато Иван го питал предния ден за Марковата къща, докторът му подарил дрехата си, защото беглецът бил дрипав. Иван сложил в джоба си бунтовнически книжа, а дрехата останала у турците. След тия известия той решава да отиде да се предаде, за да избави този добър човек.`
	fmt.Print(summary.Summarize(text, summary.NewDefaultTokenizer()))
	// Output:
